        ...
        <div className="flex items-start gap-4 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h4 className="font-semibold text-gray-900 truncate">{department.name}</h4>
              {onToggleActive && (
                <button
                  type="button"
                  onClick={(e) => {
                    e.stopPropagation();
                    onToggleActive(department, !department.is_active);
                  }}
            ...
            {department.description && (
              <p className="text-sm text-gray-500 mt-1 line-clamp-1">{department.description}</p>
            )}
            {department.center && (
