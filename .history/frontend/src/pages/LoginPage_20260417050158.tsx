          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 inset-s flex items-center ps-3 pointer-events-none">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <svg className="w-5 h-5 text-brand-400 hover:text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm2.828-6.243a1 1 0 011.415 0M19.07 4.93a1 1 0 010 1.414l-14.14 14.14a1 1 0 01-1.415-1.414l14.14-14.14a1 1 0 011.415 0zM17.657 6.343a8 8 0 000 11.314M5.343 17.657a8 8 0 000-11.314" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 3l18 18" />
                    </svg>
                  ) : (
                    <svg className="w-5 h-5 text-brand-400 hover:text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.206" />
                    </svg>
                  )}
                </button>
              </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={"w-full py-3 px-4 bg-brand-700 hover:bg-brand-600 text-white font-medium rounded-lg transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed " + btnFontClass}
            >
              {isLoading ? (
