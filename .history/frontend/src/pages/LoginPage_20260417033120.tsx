...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" dir={direction}>
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#2E4565] via-[#5C6C84] to-[#289ED5] items-center justify-center p-12">
        <div className="text-center text-white">
          <div className="w-24 h-24 rounded-2xl flex items-center justify-center mx-auto my-8">
            <svg className="w-20 h-20 text-white" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M50 5L95 25V75L50 95L5 75V25L50 5Z" stroke="currentColor" strokeWidth="2" fill="none"/>
              <path d="M50 20L75 32V68L50 80L25 68V32L50 20Z" stroke="currentColor" strokeWidth="2"/>
              <path d="M50 35L65 42V58L50 65L35 58V42L50 35Z" fill="currentColor"/>
            </svg>
          </div>
          <h1 className="text-4xl font-bold mb-4">{getTranslation(locale, 'auth.appName')}</h1>
        ...
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-8 text-center">
            <div className="w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-4">
              <svg className="w-12 h-12 text-brand-700" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M50 5L95 25V75L50 95L5 75V25L50 5Z" stroke="currentColor" strokeWidth="2" fill="none"/>
                <path d="M50 20L75 32V68L50 80L25 68V32L50 20Z" stroke="currentColor" strokeWidth="2"/>
                <path d="M50 35L65 42V58L50 65L35 58V42L50 35Z" fill="currentColor"/>
              </svg>
            </div>
            <h1 className="text-2xl font-bold text-brand-900">{getTranslation(locale, 'auth.appName')}</h1>
          </div>
