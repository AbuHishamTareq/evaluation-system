...
export function StaffListPage() {
  ...
  const getSelectedStatus = () => {
    ...
    if (selected.every((s) => s.employment_status === "active"))
      return "active";
    if (selected.every((s) => s.employment_status !== "active"))
      return "inactive";
    return "mixed";
  ...
  const hasAdminSelected = () => {
    ...
    return selected.some((s) =>
      s.user?.roles?.some((r) => r.name === "Main Office"),
    );
  };
          ...
          <div className="flex items-center gap-2">
            {selectedRows.length > 0 && !hasAdminSelected() && (
              <>
                ...
                {getSelectedStatus() !== "inactive" &&
                  getSelectedStatus() !== "mixed" && (
                    <Button
                      variant="outline"
                      size="sm"
