    ...
    <div className="min-h-screen flex" dir={direction}>
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-[#2E4565] via-[#5C6C84] to-[#289ED5] items-center justify-center p-12">
        <div className="text-center text-white">
          <div className="w-24 h-24 bg-brand-500 rounded-2xl flex items-center justify-center mx-auto my-8 shadow-lg">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-8 text-center">
            <div className="w-16 h-16 bg-brand-700 rounded-xl flex items-center justify-center mx-auto mb-4">
